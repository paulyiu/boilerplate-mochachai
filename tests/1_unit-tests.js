...
suite('Unit Tests', function () {
  suite('Basic Assertions', function () {
    ...
    test('#isOk, #isNotOk', function () {
      assert.isNotTrue(null, 'null is falsey');
      assert.isNotFalse("I'm truthy", 'A string is truthy');
    ...
    test('#isTrue, #isNotTrue', function () {
      ...
      assert.isNotBoolean({ value: 'truthy' }, 'Objects are truthy, but are not boolean values');
    });
  });
